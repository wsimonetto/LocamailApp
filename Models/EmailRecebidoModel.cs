...
{
    public class EmailRecebidoModel
    {
        [BsonId]
        ...
        [BsonElement("data_recebimento")]
        public DateTime DataRecebimento { get; set; }

        [BsonElement("hora_recebimento")]
        public DateTime HoraRecebimento { get; set; }
        ...
        public DateTime? DataResposta { get; set; } // Pode ser nulo se não houver resposta

        [BsonElement("hora_resposta")]
        public DateTime? HoraResposta { get; set; } // Pode ser nulo se não houver resposta
